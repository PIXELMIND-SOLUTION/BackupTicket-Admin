...
import MovieNames from "./Pages/MovieNames.js";
import MovieBookings from "./Pages/MovieBookings.js";
import BannerManagement from "./Pages/BannerManagement.js";
import RedemptionManagement from "./Pages/RedemptionManagement.js";
import ReportedBookings from "./Pages/ReportedBookings.js";
import PlatformCharge from "./Pages/PlatformCharge.js";
import GetNotificationPage from "./Pages/GetNotificationPage.js";
          ...
          <AdminLayout>
            <Routes>
              ...
              <Route path="/audio" element={<ManageAudios />} />
               <Route path="/usersmovietickets" element={<UserMovies />} />
              <Route path="/moviename" element={<MovieNames />} />
              <Route path="/moviebookinglist" element={<MovieBookings />} />
              <Route path="/banner" element={<BannerManagement />} />
              <Route path="/usersredemption" element={<RedemptionManagement />} />
              <Route path="/reportedbooking" element={<ReportedBookings />} />
              <Route path="/platformcharge" element={<PlatformCharge />} />
              <Route path="/getnotifications" element={<GetNotificationPage />} />
